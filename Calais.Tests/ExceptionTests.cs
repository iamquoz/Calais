...
public class ExceptionTests
{
    ...
    {
        var processor = new CalaisBuilder().ThrowOnInvalidFields(true).Build();
        ...
        act.Should()
            ...
            .Where(e =>
                e.PropertyName == "nonExistentProperty" && e.EntityType == typeof(TestUser)
            );
    }
    ...
    public void PropertyNotFilterable_ThrowsPropertyNotFilterableException()
    {
        ...
        act.Should().Throw<PropertyNotFilterableException>().Where(e => e.PropertyName == "secret");
    }
    ...
    public void PropertyNotSortable_ThrowsPropertyNotSortableException()
    {
        ...
        var query = new CalaisQuery
        {
            Sorts = [new SortDescriptor { Field = "secret", Direction = "asc" }],
        };
        ...
        act.Should().Throw<PropertyNotSortableException>().Where(e => e.PropertyName == "secret");
    }
    ...
    public void InvalidJsonPath_ThrowsInvalidJsonPathException()
    {
        ...
        act.Should().Throw<InvalidJsonPathException>().Where(e => e.Path == "singlePart");
    }
