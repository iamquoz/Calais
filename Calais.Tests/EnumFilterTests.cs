...
public class EnumFilterTests
{
	...
	public async Task Filter_Enum_Equals_MultipleValues_TreatsAsOr()
	{
		...
		result
			.Should()
			.AllSatisfy(u => u.Status.Should().BeOneOf(UserStatus.Active, UserStatus.Pending));
	}
	...
	public async Task Filter_Enum_GreaterThan_ReturnsMatchingRecords()
	{
		...
		result
			.Should()
			.AllSatisfy(u => u.Status.Should().BeOneOf(UserStatus.Suspended, UserStatus.Banned));
	}
	...
	public async Task Filter_Enum_MultipleValues_MixedIntAndString_TreatsAsOr()
	{
		...
		result
			.Should()
			.AllSatisfy(u => u.Status.Should().BeOneOf(UserStatus.Pending, UserStatus.Active));
	}
}
