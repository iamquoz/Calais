...
public class TemporalTypeFilterTests
{
    ...
    public async Task Sort_DateOnly_Ascending_OrdersCorrectly()
    {
        ...
        var allWithBirthDate = await _processor
            .ApplyFilters(context.Users, query)
            .ToListAsync(TestContext.Current.CancellationToken);
        ...
        var result = await _processor
            .ApplySorting(context.Users.Where(u => u.BirthDate != null), sortQuery)
            .ToListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task Sort_TimeOnly_Descending_OrdersCorrectly()
    {
        ...
        var result = await _processor
            .ApplySorting(context.Users.Where(u => u.PreferredContactTime != null), query)
            .ToListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task Sort_TimeSpan_Ascending_OrdersCorrectly()
    {
        ...
        var result = await _processor
            .ApplySorting(context.Users.Where(u => u.SessionDuration != null), query)
            .ToListAsync(TestContext.Current.CancellationToken);
